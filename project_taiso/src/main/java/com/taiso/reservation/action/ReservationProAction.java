...
public class ReservationProAction implements Reservation {
	...
	public ReservationForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
				...
				rezDTO.setRez_status(Integer.parseInt(request.getParameter("rez_status")));
				...
				carDTO.setCar_file(request.getParameter("car_file"));
