			...
			*/ 
			...
			public void resevationSave(ReservationDTO rezDTO, CarDTO carDTO) {
				...
				try {
					...
					// 주문정보 저장
					sql = "insert into rez_reservation(rez_uqNum,rez_rentalDate,rez_returnDate,rez_site,rez_totalDate,rez_status,car_code,car_insurance,license_num "
					...
					pstmt.setString(1, sdf.format(cal.getTime())+"-"+rez_uqNum);
					...
					pstmt.setInt(6, rezDTO.getRez_status());
					pstmt.setInt(7, rezDTO.getCar_code());
					pstmt.setString(8, rezDTO.getCar_insurance());
					pstmt.setString(9, rezDTO.getLicense_num());
					
					
					pstmt.setString(10, carDTO.getCar_brand());
					pstmt.setString(11, carDTO.getCar_name());
					pstmt.setInt(12, carDTO.getCar_location());
					pstmt.setInt(13, carDTO.getCar_price());
					pstmt.setString(14, carDTO.getCar_op());
					pstmt.setString(15, carDTO.getCar_category());
					pstmt.setString(16, carDTO.getCar_file());
					pstmt.setInt(17, carDTO.getCar_year());
					pstmt.setString(18, carDTO.getCar_fuel());
					
					
					pstmt.setString(19, rezDTO.getLicense_num());
					pstmt.setString(20, rezDTO.getLicense_issueDate());
					pstmt.setString(21, rezDTO.getLicense_type());
			...
			/**
			* 예약 1개 정보 조회 - getResevationInfo(String mem_id)
			*/ 
			...
			*/ 
			...
			public void resevationCancelSave(String mem_id) {
				...
				try {
					...
					pstmt.setInt(1, rezDTO.getRez_uqNum());
					pstmt.setInt(2, rezDTO.getPay_uqNum());
