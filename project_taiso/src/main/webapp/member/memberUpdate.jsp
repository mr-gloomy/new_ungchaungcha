...
function checkPw(){
	...
	// 비밀번호 입력 X -> submit X
	var mem_pw = document.upfr.mem_pw.value;
	
	// alert(mem_pw);
	if(mem_pw == ""){
		alert(' 비밀번호를 입력해주세요. ');
		document.upfr.mem_pw.focus();
...
function winopen2(){ // 닉네임 중복 체크
	...
	// 닉네임창에 닉네임 입력여부 확인
		 if(document.upfr.mem_nickName.value == ""){
			 alert('닉네임을 입력하세요.');
			 document.upfr.mem_nickName.focus();
			 return;
		 }
		 
	 // 입력된 아이디정보
	 var inputNName = document.upfr.mem_nickName.value;
		 
	 // 새창열기
	 window.open("./MemberNickNameCheck.me?inputNName="+inputNName,"","width=500,height=200,top=300,left=500");
	}
}
 </script>
	...
	<section class="ftco-section contact-section">
		...
		<div class="formbold-form-wrapper">
			<div class="formbold-form-title">
				...
				<form action="./MemberUpdatePro.me"  method="post" name="upfr"  onsubmit="return checkPw(); ">
					...
					<div class="formbold-mb-3">
						...
						<input type="password" name="mem_pw" id="mem_pw" placeholder="비밀번호를 입력하세요." class="formbold-form-input" required/>
					</div>
					...
					<div class="formbold-mb-3 formbold-input-wrapp">
						...
						<div>
							<input type="text" name="mem_nickName" id="mem_nickName"  value="${mDTO.mem_nickName }" class="formbold-form-input-small"/>
					...
					<div class="formbold-checkbox-wrapper">
						<label for="supportCheckbox" class="formbold-checkbox-label">
							<div class="formbold-relative">
								<input type="checkbox" name="mem_accept_sns" value='1' id="supportCheckbox" 
                  ...
                  <path
					...
					<div class="aforgot">
						...
						<a href="./MemberLogoutAction.me" id="forgot" class="font-weight-bold">로그아웃</a> 
					</div>
