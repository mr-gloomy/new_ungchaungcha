   	 ...
   	 <!-- 우측 -->
          <div class="col-md-8 block-9 mb-md-5">
            ...
            <form action="./QuestionUpdateProAction.bo?bo_num=${bodto.bo_num }" method="post" enctype="multipart/form-data" 
              ...
              <div class="form-group">
               문의사항 : <textarea name="bo_content" id="textarea" cols="30" rows="7" class="form-control" value="${bodto.bo_content }"></textarea>
              </div>
              <div>
               첨부파일 : <input type="file" name="bo_file" value="${bodto.bo_file }"/>
              </div>
              <div class="form-group">
               비밀번호 : <input type="password" id="pass" name="bo_pass" value="${bodto.bo_pass }"> 
