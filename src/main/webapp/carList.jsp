...
<!-- 		<input type="radio" value="foreign" name="car_cartegory" onclick="location.href='./CarList.ca?item=foreign';">수입차 -->
		...
		<c:set var="size" value="${carsList.size() }" />
		...
		<c:forEach begin="1" end="${row }" step="1">
			...
			<c:set var="cars" value="${carsList[num] }"/>
			<c:if test="${num < size }">
    		<div class="row">
    			<div class="col-md-4">
    				<div class="car-wrap rounded ftco-animate">
    					<div class="img rounded d-flex align-items-end" style="background-image: url(upload/${cars.car_file});">
    					</div>
    					<div class="text">
    						...
    						<div class="d-flex mb-3">
	    						...
	    						<!--${cars.car_price } * 예약페이지에서 넘긴 대여시간 --> 
	    						<p class="price ml-auto"><fmt:formatNumber value="${cars.car_price }"/>원<!-- <span>/day</span></p> -->
    						</div>
    						<p class="d-flex mb-0 d-block"><a href="./indexPro.jsp?cars=${cars }&rDate=${rDate }&rtDate=${rtDate }&rSite=${rSite }"
    						 class="btn btn-primary py-2 mr-1">예약하기</a>
    						 <a href="car-single.html" class="btn btn-secondary py-2 ml-1">차량상세정보</a></p>
