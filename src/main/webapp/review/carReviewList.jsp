...
<script type="text/javascript">
    ...
    function commentOpen(rev_num){
		...
		window.open("./reviewComment.jsp?rev_num="+rev_num,"",'width='+ _width +', height='+ _height +', left=' + _left + ', top='+ _top);
    	
    }
    
    function view(x,y,z){
    	  newin=window.open('',y,z);
    	  newin.document.write("<html><head><title>:: Image View</title></head><body background='"
    			  + x +"' onclick='self.close()' style='cursor:hand' title='CLOSED'></body></html>");
    	 }
								...
								<c:forEach var="dto" items="${reviewList }">
									<c:choose>
										...
										<c:when test="${dto.rev_lev == 0 }">
											<div class="review d-flex">
												<div class="user-img" style="background-image: url(./upload/${dto.rev_image.split(',')[0] })" OnClick="view('./upload/${dto.rev_image.split(',')[0] }','','width=500,height=400,left=0,top=0');return false"></div>
												<div class="desc">
													<h4>
